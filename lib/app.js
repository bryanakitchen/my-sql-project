...
app.get('/artists', async(req, res) => {
  try {
    ...
    `);
    // do i need to change this to join? 
...
app.post('/artists', async(req, res) => {
  try {
    ...
    VALUES ($1, $2, $3, $4, $5)
    RETURNING *`,
    [addArtist, addAlbum, addTourStatus, addGenre, addUser]);
...
app.put('/artists/:id', async(req, res) => {
  try {
    ...
    WHERE artists.id=$6
    RETURNING *`,
    [req.body.name, req.body.first_album, req.body.on_tour, req.body.genre, req.body.owner_id, artistId]);
